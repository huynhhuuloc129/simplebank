...
func (q *Queries) GetAllAccountsFromUser(ctx context.Context, owner string) ([]Accounts, error) {
	rows, err := q.query(ctx, q.getAllAccountsFromUserStmt, getAllAccountsFromUser, owner)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
